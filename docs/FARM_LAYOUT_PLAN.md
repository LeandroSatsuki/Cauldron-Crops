...
O Layout Pass V1 prioriza leitura visual e respiro sem mexer no gameplay central:



- o núcleo inicial deve parecer menos amontoado;

- o lago/pesca deve ter leitura mais periférica;

- a corrupção atual deve continuar claramente separada do miolo;

- os blocos de futuro precisam ficar mais leves e com menor opacidade;

- o painel de objetivos e popups escolhidos podem ser reposicionados/arrastados em runtime;

- nenhuma dessas mudanças deve criar novo `FarmPlot`, salvar posições ou alterar `SaveManager`.
