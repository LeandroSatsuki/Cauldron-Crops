...
var _drag_helpers: Array = []
var modal_blocker: ColorRect = null
...
func _ready() -> void:
	...
	_configurar_interfaces_arrastaveis()
...
func _configurar_interfaces_arrastaveis() -> void:



	_configurar_arraste_panel(initial_objectives_panel, "MarginContainer/VBoxObjectives/TitleLabel")



	_configurar_arraste_panel(golem_panel, "MarginContainer/VBoxGolem/TitleLabel")



	_configurar_arraste_panel(purification_panel, "MarginContainer/VBoxPurification/HeaderBar/TitleLabel")
	...
	_configurar_arraste_panel(debug_panel, "MarginContainer/ScrollContainer/VBoxDebug/TitleLabel")



	_configurar_arraste_panel(skill_tree, "PointsLabel")



	_configurar_arraste_panel(quest_board, "TitleLabel")



	_configurar_arraste_panel(recipe_book, "MarginContainer/VBoxRoot/HeaderBar/TitleLabel")
	...
	if current_scene != null:
		...
		var cauldron_popup_ui: Control = current_scene.get_node_or_null("CauldronUI/PopupLayer/CenterContainer/PopupUI") as Control



		_configurar_arraste_panel(cauldron_popup_ui, "TitleLabel")
...
func _configurar_arraste_panel(painel: Control, caminho_handle: String) -> void:
	...
	var handle: Control = painel.get_node_or_null(caminho_handle) as Control
	...
	var helper := UIDragHelperScript.new()



	helper.attach(painel, handle)



	_drag_helpers.append(helper)
...
func _garantir_modal_blocker() -> void:
	if modal_blocker != null and is_instance_valid(modal_blocker):
		return

	modal_blocker = get_node_or_null("ModalBlocker") as ColorRect
	if modal_blocker == null:
		modal_blocker = ColorRect.new()
		modal_blocker.name = "ModalBlocker"
		modal_blocker.color = Color(0.0, 0.0, 0.0, 0.001)
		...
		modal_blocker.offset_left = 0.0
		modal_blocker.offset_top = 0.0
		modal_blocker.offset_right = 0.0
		modal_blocker.offset_bottom = 0.0
